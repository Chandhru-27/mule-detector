...
# ─── Paths ────────────────────────────────────────────────────────────────────
# config.py is located in src/common/config.py
BASE_DIR  = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
DATA_DIR  = os.path.join(BASE_DIR, "data", "aml_dataset")
GRAPH_DIR = os.path.join(BASE_DIR, "cache", "graph_cache")
MODEL_DIR = os.path.join(BASE_DIR, "models", "gnn")
XGB_DIR   = os.path.join(BASE_DIR, "models", "xgboost")
OUTPUT_DIR= os.path.join(BASE_DIR, "outputs")

for _d in [DATA_DIR, GRAPH_DIR, MODEL_DIR, XGB_DIR, OUTPUT_DIR]:
